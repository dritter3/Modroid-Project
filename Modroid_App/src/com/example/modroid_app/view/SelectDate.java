...
/**
 * This activity asks user to choose the date range of the report.
 * 
 * @author Team 45
 * @version 1.0
 */
public class SelectDate extends Activity {
    ...
    /** this the datepicker of start date */
    private DatePicker startdpResult;
    /** this the datepicker of end date */
    ...
    public void addListenerOnButton() {
        ...
        btn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SelectDate.this,
                        SpendingReportView.class);
                intent.putExtra("user", userID);
                intent.putExtra("start", (startYear * 10000 + (startMonth + 1)
                        * 100 + startDay));
                intent.putExtra("end",
                        (endYear * 10000 + (endMonth + 1) * 100 + endDay));

                startActivityForResult(intent, 0);

                SelectDate.this.finish();

                System.out.println(startYear + "-" + startDay + "-"
                        + startMonth);
         ...
         * back.setOnClickListener(new View.OnClickListener() { public void
         * onClick(View v){ Intent intent = new Intent(SelectDate.this,
         * AccountManagePage.class); intent.putExtra("UserId", userId);
         * startActivity(intent); SelectDate.this.finish();
         * 
         * } });
         */
    }
