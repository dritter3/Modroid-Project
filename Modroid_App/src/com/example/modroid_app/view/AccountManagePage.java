...
public class AccountManagePage extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button viewReport = (Button)findViewById(R.id.BTN_SpendingReport);
		viewReport.setOnClickListener(new OnClickListener() {
        	public void onClick(View v) {
        		Intent loadReportPage = new Intent(AccountManagePage.this, SpendingReportView.class);
        		// send user's Id to AddBankAccount page
        		loadReportPage.putExtra("user", userID);
        		startActivityForResult(loadReportPage,0);
        	}
        });
