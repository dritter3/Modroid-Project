...
/**
 * An addBankAccount activity that allows user to
...
public class AddBankAccount extends Activity {
    ...
    protected void onCreate(final Bundle instanceState) {
        ...
        Button add = (Button) findViewById(R.id.BTN_AddingAccount);
        Button cancel = (Button) findViewById(R.id.BTN_CancelAdding);
        ...
        add.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String billingAddr = ((EditText) findViewById(R.id.ET_billingAddress))
                        .getText().toString();
                String holderName = ((EditText) findViewById(R.id.ET_HolderName))
                        .getText().toString();
                String alias = (((EditText) findViewById(R.id.ET_AccountAlias))
                        .getText().toString());
                ...
                if (accountNum.equals("") || vCode.equals("")
                    ...
                    BankAccount bank = new BankAccount(num, code, billingAddr,
                            holderName, alias);
                    
                    DatabaseHandler dbHandler = new DatabaseHandler(AddBankAccount.this);
                    
                    if (!dbHandler.checkDuplicateBankAccount(num)) { // check duplicate
                                                              // Bank Account
                        // if(((UserAccount)UserList.getUserByIDX(userIDX)).addAccount(num,
                        // code, billingAddr, holderName, alias)) {
                        // adding bank account useing ArrayList in UserAccount

                        dbHandler.addBank(bank, userId);
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        if (AddBankAccount.this == null)
                                            System.out
                                                    .println("AddBankAccount.this is null");
