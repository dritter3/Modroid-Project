...
public class FullscreenActivity extends Activity {
    ...
    /**
     * The instance of DatabaseHandler for this activity.
     */
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (!dbHandler.checkDuplicateUser(AdminAccount.USER)) {
            dbHandler.addUser(AdminAccount.USER);
        ...
        registerButton.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent loadRegisterPage = new Intent(FullscreenActivity.this,
                        Register_Page.class);
        ...
        loginButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent loadLoginPage = new Intent(FullscreenActivity.this,
                        LoginPage.class);
    ...
    /**
     * The instance of Handler for this activity.
     */
